...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id2\xd7\x02\n" +
	...
	"\x0eListCategories\x12\t.pb.blank\x1a\x10.pb.CategoryList\"\x00\x129\n" +
	"\vGetCategory\x12\x1a.pb.GetCategoryByIDRequest\x1a\f.pb.Category\"\x00B\rZ\vinternal/pbb\x06proto3"
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*GetCategoryByIDRequest)(nil), // 4: pb.GetCategoryByIDRequest
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	4, // 5: pb.CategoryService.GetCategory:input_type -> pb.GetCategoryByIDRequest
