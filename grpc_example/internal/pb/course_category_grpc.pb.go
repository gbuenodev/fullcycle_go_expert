...
type CategoryServiceClient interface {
	...
	GetCategory(ctx context.Context, in *GetCategoryByIDRequest, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) GetCategory(ctx context.Context, in *GetCategoryByIDRequest, opts ...grpc.CallOption) (*Category, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	GetCategory(context.Context, *GetCategoryByIDRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) GetCategory(context.Context, *GetCategoryByIDRequest) (*Category, error) {
